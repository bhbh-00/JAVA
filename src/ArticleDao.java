...
public class ArticleDao {
	...
	public ArticleDao() {
		...
		Article list1 = new Article(1, "제목1", "내용1", "익명", getCurrenDate());
		Article list2 = new Article(2, "제목2", "내용2", "익명", getCurrenDate());
		Article list3 = new Article(3, "제목3", "내용3", "익명", getCurrenDate());
